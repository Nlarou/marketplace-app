...
function EditListing() {
  ...
  const onSubmit = async (e) => {
    ...
    const res = await fetch(
      `https://maps.googleapis.com/maps/api/geocode/json?address=${location}&key=AIzaSyCVUcHehJUWyRhkEd6iujNbbD7DIGKx3Vc`
    );
  ...
  return (
    <div className="lg:w-1/2 mx-auto">
      <header>
        <div className="p-2">
          <p className="font-bold text-2xl">Edit of {listing.name}</p>
        </div>
      </header>
      <main>
        <form
